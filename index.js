...
function getData() {
  ...
  textarea.addEventListener("input", () => {
    ...
    // Loop only once through the string using char codes (faster than RegEx)
    ...
    countDisplay.textContent = `Letters Count : ${letterCount}`;
  });
  ...
  addButton.addEventListener("click", function () {
    ...
    document.querySelector("#count").innerText = `Letters Count : 0`;
  ...
  function appendNote(note) {
    ...
    var colorHotPink = generateColorButton("hotpink");
    ...
    noteControls.appendChild(colorHotPink);
